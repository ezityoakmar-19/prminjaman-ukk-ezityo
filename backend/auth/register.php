...
<head>
    <meta charset="utf-8">
    <title>Register | Peminjaman Proyektor - Rental Proyektor Profesional</title>
    ...
    <style>
        ...
        @keyframes beamMove {
            0%, 100% { opacity: 0.2; transform: skewX(-20deg) rotate(15deg) translateX(0); }
            50% { opacity: 0.4; transform: skewX(-20deg) rotate(15deg) translateX(30px); }
        }
        ...
        @media (max-width: 768px) {
            ...
            .card-header-register { padding: 25px 20px; }
        }

        /* Tambahan CSS untuk canvas 3D */
        #projector-canvas-3d {
            position: fixed;
            top: 0;
            left: 0;
...
<body>
    <!-- Canvas untuk proyektor 3D bergerak -->
    <canvas id="projector-canvas-3d"></canvas>
            ...
            <div class="col-lg-5 col-md-8">
                <div class="card card-register">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-center text-muted mb-4">Daftar sekarang untuk meminjam proyektor</p>
                        ...
                        <form method="POST">
                            <div class="mb-3">
                                <label class="form-label">
                                    <i class="fas fa-id-card" style="color: var(--primary-color); margin-right: 8px;"></i> Nama Lengkap
                                </label>
                            ...
                            <div class="mb-3">
                                <label class="form-label">
                                    <i class="fas fa-user" style="color: var(--primary-color); margin-right: 8px;"></i> Username
                                </label>
                            ...
                            <div class="mb-4">
                                <label class="form-label">
                                    <i class="fas fa-lock" style="color: var(--primary-color); margin-right: 8px;"></i> Password
                                </label>
                        ...
                        <div class="text-center mt-4">
                            <small class="text-muted">
                                <i class="fas fa-video me-1" style="color: var(--primary-color);"></i> 
                                Peminjaman Proyektor - Rental Proyektor Profesional &copy; <?= date('Y'); ?>
                            </small>
                        </div>
                    </div>
                </div>
    ...
    <script>
        (function() {
            // Inisialisasi scene, camera, renderer untuk 3D
            const canvas = document.getElementById('projector-canvas-3d');
